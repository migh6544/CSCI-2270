...
int main(int argc, char const *argv[])
{
    ...
    //tracks average number of insert collisions per 100 operations
    ...
    for (int i = 0; i < 400; i++)
    {
        ...
        //calculate and store number of collisions per 100 searched, then reset to 0
        numOfCol = run.getNumOfCollision();
    ...
    //write to file
    ofstream output_HashLL("output_HashLP_B.csv");
